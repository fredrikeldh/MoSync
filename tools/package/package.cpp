...
"                              generated by elfStabSld. Used by iOS.\n"
...
"     --wp-config <name>       Configuration name (Windows Phone only).\n"
//"     --wp-target              Ignored (Windows Phone only).\n"
"     --wp-guid <guid>         Application's GUID (Windows Phone only).\n"
"     --wp-project-only        Don't build the generated Windows Phone project.\n"
"                              Required on non-Windows hosts.\n"
"     --wp-vs-build-path <path>The path to the MS build executable for building\n"
"                              the generated Windows Phone project\n"
"                              (Windows only).\n"
"                              Required if --wp-project-only is not specified.\n"
"     --cs-output <path>       Input: Absolute path to a directory containing\n"
"                              'rebuild.build.cs' and 'data_section.bin',\n"
"                              generated by elfStabSld. Used by Windows Phone.\n"
// Re-enable later
